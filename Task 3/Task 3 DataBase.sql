...
CREATE TABLE lessons (
 id SERIAL NOT NULL,
 lesson_mode VARCHAR(100),
 lesson_level VARCHAR(100) NOT NULL,
 ensemble_mode VARCHAR(100),
 time_slot DATETIME,
 place VARCHAR(100),
 min_seats INT,
 booked_seats INT,
...
ALTER TABLE students ADD CONSTRAINT FK_students_0 FOREIGN KEY (contact_person_id SERIAL) REFERENCES contact_person (id);
